...
//        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.layout_for_fragment, new BeritaFragment())
                    .commit();
            getSupportActionBar().setTitle("Berita");
        } else if (id == R.id.nav_pengaduan) {
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.layout_for_fragment, new PengaduanFragment())
                    .commit();
            getSupportActionBar().setTitle("Pengaduan");
        } else if (id == R.id.nav_tentang) {
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.layout_for_fragment, new TentangFragment())
                    .commit();
