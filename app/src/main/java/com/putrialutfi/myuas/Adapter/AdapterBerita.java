...
import com.putrialutfi.myuas.DetailActivity;
...
public class AdapterBerita extends RecyclerView.Adapter<AdapterBerita.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        // Dapatkan url gambar
        final String urlGambarBerita = "http://192.168.43.75/uasberita/images/" + berita.get(position).getFoto();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                varIntent.putExtra(
                        "TGL_BERITA", berita.get(position).getTanggalPosting());
                varIntent.putExtra(
                        "PNS_BERITA", berita.get(position).getPenulis());
                varIntent.putExtra(
                        "FTO_BERITA", urlGambarBerita);
                varIntent.putExtra(
                        "ISI_BERITA", berita.get(position).getIsiBerita());
